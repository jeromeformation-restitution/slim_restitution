...
return [
    ...
    Database::class => function (ContainerInterface $container) {
        $tab = $container->get('parameters'); // On accéde à la clés parameters dans container
        return new Database( // On définit les paramètres de Database
            $tab['database_user'], // les différentes clés
            $tab['database_name'],
            $tab['database_host'],
            $tab['database_password']
        );
    }
];
